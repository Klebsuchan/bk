...
export function LandingPageView({ onLaunch }: LandingPageViewProps) {
  ...
  const WALLETS = [
    ...
    { id: 'xdefi', name: 'XDEFI', color: 'text-blue-400', bg: 'bg-blue-500/20', Icon: Zap },
    { id: 'clv', name: 'Clover (CLV)', color: 'text-green-500', bg: 'bg-green-500/20', Icon: Zap },
    { id: 'avana', name: 'Avana', color: 'text-purple-300', bg: 'bg-purple-500/20', Icon: Zap },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#f5f5f5] selection:bg-[#99ff66] selection:text-black font-sans pb-0 overflow-x-hidden relative">
      ...
      <main className="px-4 md:px-8 max-w-[1600px] mx-auto mt-6">
        ...
        >
          <div className="absolute inset-0 grayscale contrast-125 opacity-80 mix-blend-screen transition-transform duration-1000 group-hover:scale-105">
            <img 
        ...
        >
          ...
          <div className="col-span-1 lg:col-span-7 flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-8 mb-16 items-start border-t border-white/20 pt-10">
               <div className="w-28 h-28 rounded-full overflow-hidden border border-white/30 shrink-0 relative group">
